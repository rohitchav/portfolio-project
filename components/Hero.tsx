...
const Hero: React.FC = () => {
  return (
    <section id="home" className="relative h-screen flex items-center bg-slate-900 text-white overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl">
          <p className="text-blue-400 font-semibold tracking-widest uppercase mb-4 animate-fadeIn">Backend Engineering</p>
          <h1 className="text-5xl md:text-7xl font-bold leading-tight mb-6">
            Hi, I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-500">Rohit Chavan</span>
          </h1>
          <h2 className="text-2xl md:text-3xl text-slate-300 font-medium mb-8">
            Java Backend Developer 
          </h2>
          <p className="text-lg text-slate-400 mb-10 max-w-xl leading-relaxed">
            I specialize in building scalable, database-driven applications with robust architectures and efficient report development.
          </p>
