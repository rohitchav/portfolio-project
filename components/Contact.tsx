        ...
        <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col lg:flex-row">
          ...
          <div className="lg:w-2/5 bg-blue-600 p-12 text-white">
            ...
            <p className="text-blue-100 mb-10 text-lg">
              I'm always open to discussing new opportunities, professional collaborations, or technical challenges.
            </p>
            ...
            <div className="space-y-8">
              {CONTACT_LINKS.map((link) => (
                <div key={link.name} className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-sm text-blue-200 uppercase font-bold tracking-widest">
                      {link.name}
                    </p>
                    <a
                      href={link.href}
          ...
          <div className="lg:w-3/5 p-12">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <button
                ...
                className={`w-full py-4 flex items-center justify-center gap-3 font-bold rounded-xl transition-all transform shadow-lg ${
